    ...
    <div className={`w-full max-w-3xl ${className}`}>
      ...
      <div className="relative">
        ...
        {showTarget && target != null && (
          ...
          >
            <div className="w-10 h-10 rounded-full bg-[var(--color-ordklap)] ring-4 ring-[var(--color-ordklap)]/30 flex items-center justify-center shadow-lg shadow-[var(--color-ordklap)]/20">
        ...
        {guesses?.map((g, i) => (
          ...
          >
            <div className="flex flex-col items-center gap-0.5">
              ...
              {g.score != null && (
                <span className={`text-xs font-bold ${g.score > 0 ? "text-[var(--color-ordklap)]" : "text-[var(--color-text-muted)]"}`}>
                  +{g.score}
                </span>
              )}
            </div>
