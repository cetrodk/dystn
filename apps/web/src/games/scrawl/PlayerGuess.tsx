  ...
  if (isArtist) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-4 p-4">
        ...
        <p className="font-display text-2xl font-bold">{da.scrawl.youAreTheArtist}</p>
        <p className="text-[var(--color-text-muted)]">{da.scrawl.watchThemGuess}</p>
