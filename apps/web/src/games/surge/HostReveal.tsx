  ...
  return (
    <div className="flex flex-1 min-h-0 w-full flex-col items-center gap-5">
      ...
      >
        ...
        >
          {isCorrectTrue ? da.surge.sandt : da.surge.falsk}
        </motion.div>
      </motion.div>
      ...
      >
        <button
          ...
          className="rounded-2xl bg-[var(--color-surge)] px-12 py-5 text-2xl font-bold text-white transition-transform hover:scale-105 active:scale-95 cursor-pointer"
        >
          {da.nextRound}
        </button>
