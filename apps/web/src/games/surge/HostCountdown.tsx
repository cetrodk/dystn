  ...
  return (
    <div className="relative flex flex-1 min-h-0 w-full flex-col items-center gap-8">
      ...
      <motion.div
        ...
        style={{
          background: "radial-gradient(circle at 50% 30%, var(--color-surge-glow) 0%, transparent 60%)",
        }}
      />
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className="font-display text-9xl font-bold text-[var(--color-surge)]"
          style={{
            textShadow: "0 0 40px var(--color-surge), 0 0 80px color-mix(in srgb, var(--color-surge) 30%, transparent)",
          }}
        >
          {count > 0 ? count : "KØR!"}
        </motion.div>
