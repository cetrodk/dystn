    ...
    <form onSubmit={handleSubmit} className="mt-4 flex flex-col gap-2">
      ...
      <div className="flex flex-col gap-2 sm:flex-row">
        <input
          ...
          autoCorrect="off"
          spellCheck={false}
          className="nb-border min-w-0 flex-1 rounded-xl bg-[var(--color-paper)] px-3 py-2.5 font-mono text-sm tracking-wider uppercase placeholder:text-[var(--color-text-muted)]/50 focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
        />
        <button
          type="submit"
